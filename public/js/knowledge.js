function mostrarSeleccion() {
  // Obtener los checkboxes seleccionados individualmente por su id
  const mantenimiento1 = document.getElementById('mantenimiento1');
  const mantenimiento2 = document.getElementById('mantenimiento2');
  const mantenimiento3 = document.getElementById('mantenimiento3');
  const mantenimiento4 = document.getElementById('mantenimiento4');
  const mantenimiento5 = document.getElementById('mantenimiento5');

  // Crear la base de conocimiento según las selecciones
  let baseConocimiento = "";

  if (mantenimiento1.checked) {
